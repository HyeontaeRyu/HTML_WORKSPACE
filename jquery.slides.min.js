  ...
  (function (e, t, n) {
    ...
    r.prototype.init = function () {
      ...
      if (this.options.navigation.active) {
        ...
        r = e("<a>", { "class": "slidesjs-next slidesjs-navigation", href: "#", title: "Next", text: "Next" }).appendTo(
          n
        );
      }
      ...
      if (this.options.play.active) {
        s = e("<a>", { "class": "slidesjs-play slidesjs-navigation", href: "#", title: "Play", text: "Play" }).appendTo(
          n
        );
        u = e("<a>", { "class": "slidesjs-stop slidesjs-navigation", href: "#", title: "Stop", text: "Stop" }).appendTo(
          n
        );
        s.click(function (e) {
          e.preventDefault();
    ...
    r.prototype._touchend = function (t) {
      ...
      if (
        ...
        (s.position().left > this.options.width * 0.1 && Number(new Date()) - this.data.touchtimer < 250)
      ) {
        e.data(this, "direction", "previous");
        this._slide();
      } else if (
